...
import { calcularPrecioAsync, selectCantidad, selectFinalPrice, setCantidad } from '../Facebook/Hooks/FacebookSlice';
import axios from 'axios';
import { API_COMPRAR } from '../../config';
import Swal from 'sweetalert2';
import QuantitySectionYoutube from './QuantitySectionYoutube';

const YoutubeComprar = ({ service }) => {
