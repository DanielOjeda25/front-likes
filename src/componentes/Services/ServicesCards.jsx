...
const ServicesCards = ({ to, svg, title }) => {
  return (
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 overflow-hidden transition-transform transform hover:scale-105">
      <a className="text-center flex justify-center p-2">
        {svg}
      </a>
      <div className="p-5">
        <a>
        ...
        <div className="flex flex-col w-full mx-auto justify-center items-center">
          <a
            href={to}
            className="inline-flex cursor-pointer items-center px-3 py-2 font-normal text-center text-white bg-red-500 hover:bg-red-900 rounded my-2"
          >
            Ver servicios
